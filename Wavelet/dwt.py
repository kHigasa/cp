...
sq3 = sqrt(3); fsq2 = 4.0 * sqrt(2); N = 1024
c0 = (1 + sq3) / fsq2; c1 = (3 + sq3) / fsq2
...
def daube4(f, n, sign):
    ...
    if (sign >= 0):
        ...
        transf = gvbars(delta=2.*n/N, color=color.cyan)
        ...
        transf2 = gvbars(delta=2.*n/N, color=color.cyan)
        while j <= n - 3:
            rate(speed)
