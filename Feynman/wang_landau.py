...
entgr = graph(x=0,y=0,width=500,height=250,title='Density of States', xtitle= 'E/N', ytitle='log g(E)', xmax=2., xmin=-2.,ymax=45,ymin=0)
entrp    = gcurve(color = color.yellow)
energygr = graph(x=0, y=250, width=500, height=250, title='E vs T',\
        xtitle = 'T', ytitle='U(T)/N', xmax=8.,xmin=0, ymax =0.,ymin=-2.)
energ    = gcurve(color = color.cyan)
histogr  = graph(x = 0, y = 500, width = 500, height = 300, title = '1st histogram: H(E) vs. E/N, corresponds to log(f) = 1')
